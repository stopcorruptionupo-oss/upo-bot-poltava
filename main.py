...
ANSWERS = {
    ...
    "Р2.1": ("👥 <b>Розділ 2.1: Члени сім'ї</b>\n\n"
             "Сюди вписуємо: чоловіка/дружину (навіть якщо не живете разом, але в шлюбі), дітей до 18 років (незалежно від місця проживання) та осіб, що спільно проживають понад 183 дні.\n"
    ...
    "Р11": ("💰 <b>Розділ 11: Доходи та подарунки</b>\n\n"
            "<b>Ваші та ВСІХ членів сім'ї</b>. Зарплата (до вирахування податків), пенсія, соцвиплати, аліменти, відсотки, подарунки.\n"
    ...
    "Р12.1": ("💳 <b>Розділ 12.1: Банківські та інші фінансові установи</b>\n\n"
              "<b>⚠️ ПРАВИЛО ЗАПОВНЕННЯ:</b>\n"
              "У цьому розділі ми вказуємо <b>ТІЛЬКИ НАЗВИ БАНКІВ</b> (або інших фінустанов), у яких у вас або членів сім'ї відкриті рахунки.\n"
              "• Номери рахунків (IBAN) вписувати НЕ потрібно.\n"
              "• Обираєте назву банку зі списку (наприклад: ПриватБанк, Ощадбанк, Універсал Банк/Монобанк).\n"
              "• Вказуємо банки, де рахунки були відкриті хоча б один день протягом звітного року, навіть якщо зараз вони закриті.\n"
    ...
    "Р13": ("📉 <b>Розділ 13: Фінансові зобов’язання</b>\n\n"
            "Кредити, отримані позики, заборгованість по кредитних лімітах (ваші та сім'ї). Пишемо, якщо борг > 50 ПМ.\n"
